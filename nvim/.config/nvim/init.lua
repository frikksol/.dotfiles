...
require('lazy').setup({
  ...
  'github/copilot.vim', -- Install copilot. Remember to run Copilot setup after first start
  ...
  { -- Autocompletion
    ...
    opts = {
      keymap = {
        ...
        ['<C-shift-enter>'] = { 'select_prev', 'fallback' },
  ...
  { -- Noice for clean notifications and command input
    'folke/noice.nvim',
    event = 'VeryLazy',
    opts = {
